					...
					<div style="width: 100%";>
						<li class="inputbox"><center>
								<label class="u-label"><img
									...
									alt="用户名" style="position: relative; top: 3px; right: 2px;" />云知帐号或手机号</label>
								<input name="user" class="j-inputtext" type="text"
						...
						<li class="inputboxp"><center>
								...
								<input name="pass" class="j-inputtext" type="text"
						...
						<li class="inputboxp"><center>
								<a class="u-loginbtn" tabindex="6" target="_self"
									href="index.html">登&nbsp;&nbsp;录</a> <a class="u-loginbtnp"
									href="http://www.baidu.com" target="_blank" tabindex="7"
									style="margin-left: 5%">注&nbsp;&nbsp;册</a>
							</center></li>
					</div>
				</div>
			</div>
