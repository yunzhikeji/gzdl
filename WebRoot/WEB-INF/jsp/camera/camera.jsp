...
<body style="background:#e9eef0;">
 ...
 <button class="button blue bla smallrounded" style="font-size:14px; line-height:14px;margin-left:75%"; onClick="ypgy('设备入库','${pageContext.request.contextPath }/equip/toAdd','1024px','768px')" ><i class="Hui-iconfont">&nbsp;&#xe600;&nbsp;</i>设备入库</button></div>
 <div class="sJ0"></div>
 <div style="height:740px">
  <table class="table" style="width:98%; margin:5px auto">
    ...
    <tr bgcolor="#f6f6f6">
        ...
        <th width="20%" style="font-size:14px;">SIP编号</th>
        <th width="30%" style="font-size:14px;">单位名称</th>
      ...
      <tr class="text-c">
        ...
        <td>hfaifhdiu1125</td>
        <td>越秀城南区ce</td>
        <td><a href="javascript:;"onClick="ypgy('设备租售','${pageContext.request.contextPath }/equip/toUpdate','1024px','768px')" title="设备租售" target="_self" class="button blue bigrounded bla" style="font-size:14px;line-height:14px"><i class="Hui-iconfont">&nbsp;&nbsp;&nbsp;&#xe647;</i>编辑&nbsp;&nbsp;&nbsp;</a></td>
        <td><a href="javascript:;" onClick="ypgy('设备租售','${pageContext.request.contextPath }/equip/toUpdate','1024px','768px')" title="设备租售" target="_self" class="button blue bigrounded bla" style="font-size:14px;line-height:14px"><i class="Hui-iconfont">&nbsp;&nbsp;&nbsp;&#xe672;</i>出租&nbsp;&nbsp;&nbsp;</a></td>
