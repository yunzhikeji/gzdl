  ...
  <table class="table" style="width:98%; margin:5px auto">
    ...
    <tr bgcolor="#f6f6f6">
      ...
      <tr class="text-c">
        ...
        <td><a href="javascript:;"onClick="ypgy('设备编辑','${pageContext.request.contextPath }/camera/toUpdate','1024px','768px')" title="设备租售" target="_self" class="button blue bigrounded bla" style="font-size:14px;line-height:14px"><i class="Hui-iconfont">&nbsp;&nbsp;&nbsp;&#xe647;</i>编辑&nbsp;&nbsp;&nbsp;</a></td>
