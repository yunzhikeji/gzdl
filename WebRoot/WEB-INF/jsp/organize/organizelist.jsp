...
<title>组织管理</title>
<link href="${pageContext.request.contextPath }/css/datePicker1.css" rel="stylesheet" type="text/css"
	media="all" />
...
<body style="background: #e9eef0;">
	<div class="bht">
		<div class="bh text-d">
			施工单位列表 <input type="text" class="date_picker" placeholder="单位名称"
				style="width: 150px" />
			...
			<table class="table" style="width: 98%; margin: 5px auto">
				<thead class="text-c">
					<tr bgcolor="#f6f6f6">
						...
						<th width="25%" style="font-size: 14px;">单位名称</th>
						<th width="40%" style="font-size: 14px;">单位所属区域</th>
