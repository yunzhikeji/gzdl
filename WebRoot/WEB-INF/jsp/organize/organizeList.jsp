	...
	<div class="bht">
		<div class="bh text-d">
			单位列表 <span style="margin-left: 20px"><select
				...
				id="show"></span> <input type="text" class="date_picker"
 ...
 <div style="height:740px">
  <table class="table" style="width:98%; margin:5px auto">
    ...
    <tr bgcolor="#f6f6f6">
        ...
        <th width="10%" style="font-size:14px;">单位名称</th>
        <th width="20%" style="font-size:14px;">所属区域</th>
       <th width="8%" style="font-size:14px;">联系人</th>
        <th width="8%" style="font-size:14px;">联系电话</th>
        <th width="8%" style="font-size:14px;">组织类别</th>
      ...
      <tr class="text-c">
        ...
        <td><button class="button orange bla smallrounded" style="font-size:14px;line-height:14px" onClick="OnUp();"><i class="Hui-iconfont">&nbsp;&#xe609;&nbsp;</i>删除</button></td>
							...
							<td><c:if test="${organize.type ==1}"> 供电局</c:if>
								<c:if test="${organize.type ==2}"> 施工单位</c:if></td>
