...
<body>
  ...
  <div class="yzrtvb">
   <button class="button white" onclick="ClearPoly()" style="box-shadow: 1px 2px 1px 1px rgba(51,51,51,0.3);"><i class="iconfont">&nbsp;&#xe609;&nbsp;</i>浏览地图</button>
   <button class="button white" id="addsite" onclick="addSite()" style="margin:5px 16px; box-shadow: 1px 2px 1px 1px rgba(51,51,51,0.3);"><i class="iconfont">&nbsp;&#xe613;&nbsp;</i>添加工地</button> 
   <button class="button white" id="delsite" onclick="deleteSite()" style="box-shadow: 1px 2px 1px 1px rgba(51,51,51,0.3);"><i class="iconfont">&nbsp;&#xe612;&nbsp;</i>删除工地</button>   
</div></div>           
	<div id="map_canvas"
		style="margin:0 auto; width: 100%; height: 862px;">
		地图加载失败....</div>
</body>
</html>
