...
public class UserController {
	...
	public ModelAndView queryUsers(OrganizeQueryVO organizeQueryVO, HttpServletRequest request) throws Exception {
		...
		for (int i = 0; userList != null && i < userList.size(); i++) {
			...
			if (user.getOrganizeid() == 0) {
				...
				Organize organize = organizeService.selectByPrimaryKey(user.getOrganizeid());
	...
	public String editUserSubimt(Model model, HttpServletRequest request, Integer id, UserCustom userCustom)
			throws Exception {
	...
	public String addUser(HttpServletRequest request, String username, String organizeName, Integer role)
			throws Exception {
